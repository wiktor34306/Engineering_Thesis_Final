...
import './EditNameOfAcademicDepartmentAdminStyle.css';
import { toast } from 'react-toastify';
import config from '../../../config';
import { useNavigate } from 'react-router-dom';

export const EditNameOfAcademicDepartmentAdmin = ({ open, handleClose, selectedTopic }) => {
    ...
    >
      <Box className="edit-academic-department-name-form-modal">
        ...
        <form className="edit-academic-department-name-admin">
          ...
          <Button
            id="academic-department-name-accept-button-admin"
            type="button"
            onClick={(e) => {
              e.preventDefault();
