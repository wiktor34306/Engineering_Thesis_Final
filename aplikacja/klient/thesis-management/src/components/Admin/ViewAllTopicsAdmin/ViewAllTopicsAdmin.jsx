...
import { EditTopicNameAdmin } from '../EditTopicNameAdmin/EditTopicNameAdmin';
import Papa from 'papaparse';
import { useNavigate } from 'react-router-dom';
import { AssignStudentToTopicAdmin } from '../AssignStudentToTopicAdmin/AssignStudentToTopicAdmin';
import { ConfirmWindowDeleteTopicAdmin } from '../ConfirmWindowDeleteTopicAdmin/ConfirmWindowDeleteTopicAdmin';
    ...
    <>
      <div className="topics-admin-container">
        ...
        <div className="topics-admin-element">
          ...
          <table className="styled-table-with-topics-admin">
            <thead>
              <tr>
              <th>lp.</th>
                <th>temat</th>
            ...
            <tbody>
              {topics.map((topic, index) => (
                  ...
                  <td>
                    <button className="button-view-all-topics-admin-edit" onClick={() => handleEditButtonClick(topic)}>
                      Edytuj nazwę
                    </button>

                    <button className="button-view-all-topics-admin-delete" onClick={() => handleDeleteButtonClick(topic)}>
                      Usuń temat
                  </button>
                  </td>
                </tr>
          ...
          <div className="button-div-view-all-topics-admin-gen-csv">
          <button className="button-view-all-topics-admin-generate-csv" type="submit" onClick={generateCSV}>Generuj plik CSV z podziałem na studentów i tematy</button>
        
          <button className="button-view-all-topics-admin-generate-csv button-view-all-topics-admin-assign-to" type="submit" onClick={handleOpenAssignModal}>
