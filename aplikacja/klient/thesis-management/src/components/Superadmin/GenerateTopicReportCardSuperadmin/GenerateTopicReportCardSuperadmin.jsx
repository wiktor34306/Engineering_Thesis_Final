...
import './GenerateTopicReportCardSuperadminStyle.css';
import { useNavigate } from 'react-router-dom';
import config from '../../../config';
import { getUserId } from '../../../getUserId';

export const GenerateTopicReportCardSuperadmin = ({ open, handleClose }) => {
  ...
  return (
    ...
    >
      <Box className="super-admin-registration-form-modal">
        <IconButton
          aria-label="close"
          onClick={handleClose}
        ...
        <form className="super-admin-registration-admin">
          ...
          />
            ...
            <label htmlFor="academic-department-select-super-admin">Wydział:</label>
            <select
              className="academic-department-select-super-admin"
          ...
          <label htmlFor="academic-department-select-super-admin">Katedra:</label>
          <select
            className="academic-department-select-super-admin"
          ...
          <TextareaAutosize
            className="textarea-properties-generate-super-admin"
            minRows={5}
          ...
          <Button
            id="super-admin-accept-button-generate-topic-card"
            type="submit"
            onClick={(e) => {
              e.preventDefault();
