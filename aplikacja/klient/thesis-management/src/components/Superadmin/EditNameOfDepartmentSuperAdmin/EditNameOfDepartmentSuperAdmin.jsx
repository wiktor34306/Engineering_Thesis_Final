...
import './EditNameOfDepartmentSuperAdminStyle.css';
import { toast } from 'react-toastify';
import config from '../../../config';
import { useNavigate } from 'react-router-dom';

export const EditNameOfDepartmentSuperAdmin = ({ open, handleClose, selectedTopic }) => {
    ...
    >
      <Box className="edit-topic-name-form-modal">
        ...
        <form className="edit-topic-name-admin">
          ...
          <Button
            id="department-name-accept-button-admin"
            type="button"
            onClick={(e) => {
              e.preventDefault();
