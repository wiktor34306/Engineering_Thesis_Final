...
import './EditNameOfSubjectSuperAdminStyle.css';
import { toast } from 'react-toastify';
import config from '../../../config';
import { useNavigate } from 'react-router-dom';

export const EditNameOfSubjectSuperAdmin = ({ open, handleClose, selectedTopic }) => {
  ...
  return (
    ...
    >
      <Box className="edit-subject-name-form-modal">
        ...
        <form className="edit-subject-name-super-admin">
          <TextField
          ...
          <Button
            id="subject-name-accept-button-super-admin"
            type="button"
            onClick={(e) => {
              e.preventDefault();
